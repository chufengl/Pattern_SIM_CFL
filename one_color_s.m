%"one_color_s.m" is a segment of "one_color_randori.m"
...
% the following is true only for orthorhombic lattices, if not, should
% include non-zero non-diagonal elements of A.
